...
getPaths: function(){
  ...
  "depth": 0
        ...
        outerShapeSelfIntersect: { path: [ {X:50,Y:50}, {X:150,Y:50}, {X:150,Y:150}, {X:125,Y:150},{X:100,Y:50},{X:75,Y:150}, {X:50,Y:150} ], depth:100},
        lowerCaseHole: { path: [{x:75,Y:60},{x:75,y:180},{X:100,y:180},{X:100,Y:60}], depth: 0 },
    };
},
...
getTestPaths: function () {
    ...
    const res =  [{
        ...
        result:{
          ...
          name: "one inner and one outer 0",
          outerShape:input.outerShape,
          ...
          name: "one inner 50 and one outer 0",
          outerShape:input.outerShape,
          ...
          name: "one inner 0 and one outer 50",
          outerShape:input.outerShape,
          ...
          name: "two inner 50 and one outer 0",
          outerShape:input.outerShape,
      ...
      {
          name: "input_4",
          outerShape: JSON.parse('{"path":[{"X":1617.23655,"Y":-268.56688},{"X":1647.23655,"Y":-298.56688},{"X":-474.74283,"Y":-298.56688},{"X":-444.74283,"Y":-268.56688}],"depth":250}'),
          holes: JSON.parse('[{"path":[{"X":1617.23655,"Y":-268.56688},{"X":-444.74283,"Y":-268.56688},{"X":-474.74283,"Y":-298.56688},{"X":1647.23655,"Y":-298.56688}],"depth":0.1},{"path":[{"X":1627.23655,"Y":-278.56688},{"X":1627.23655,"Y":524.92507},{"X":880.6194451329999,"Y":524.92507},{"X":870.6194451329999,"Y":514.92507},{"X":870.6194451329999,"Y":-268.56687999999997},{"X":880.6194451329999,"Y":-278.56687999999997}],"depth":0}]'),
      ...
      {
        name: "hole in hole in hole 50",
        outerShape:input.outerShape,
        holes: [getholes.changeDepth(input.inHole3, 50), input.inHole4, input.inHole5],
        result: {
            frontMesh:84,
            backMesh:48,
            outMesh:48,
    ...
    {
      name: "hole in hole in hole 50 20",
      outerShape:input.outerShape,
      holes: [getholes.changeDepth(input.inHole3, 50),getholes.changeDepth(input.inHole4, 20), input.inHole5],
      result: {
          frontMesh:84,
          backMesh:24,
          outMesh:48,
    ...
    {
      name: "selfIntersects",
      outerShape:input.outerShapeSelfIntersect,
      holes: [],
      result: {
          frontMesh:12,
          backMesh:12,
      ...
      {
      name: "lowerCasePoints",
      outerShape:input.outerShape,
      holes:[input.lowerCaseHole],
      result:{
       frontMesh:18,
       backMesh:18,
       outMesh:48,
