...
getTestPaths: function () {
    ...
    const res =  [{
      ...
      ,{
          outerShape:input.newBugShape1,
          holes: input.newBugPaths1,
          result:{}
      }
      ,{
          outerShape:input.newBugShape2,
          holes: input.newBugPaths2,
          result:{}
      }
      ,{
          outerShape:input.newBugShape3,
          holes: input.newBugPaths3,
          result:{}
      }
  ];
...
doNotBuild: function (options, paths) {
    if (!paths) return;
